import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { unref, getCurrentInstance, inject, hasInjectionContext, ref, computed, defineAsyncComponent, defineComponent, h, shallowRef, provide, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { u as parseURL, g as encodePath, d as decodePath, o as hasProtocol, p as isScriptProtocol, r as joinURL, C as withQuery, w as sanitizeStatusCode, i as getContext, $ as $fetch, e as defu, c as createError$1, h as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./create-C78_Jy5t.mjs')
  },
  {
    name: "admin-users-id",
    path: "/admin/users/:id()",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./_id_-V9s-f14r.mjs')
  },
  {
    name: "admin-activities",
    path: "/admin/activities",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./index-CXmwGf9d.mjs')
  },
  {
    name: "admin-donations",
    path: "/admin/donations",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./index-Apecb76K.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./login-BF1jwKRp.mjs')
  },
  {
    name: "admin-points",
    path: "/admin/points",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./index-psr3H3u0.mjs')
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-BOUzBWwg.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta || {},
    component: () => import('./index-DOty1lVW.mjs')
  }
];
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-ByUIF1zz.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-BO-Ss4Kw.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dbqe-Qk0.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CM8Fuwh2.mjs'));
...
export { _export_sfc as _, isElement as a, isEmpty as b, isNumber as c, debugWarn as d, entry_default as default, encodeRoutePath as e, isPropAbsent as f, isStringNumber as g, isUndefined as h, isBoolean as i, isWindow as j, navigateTo as k, nuxtLinkDefaults as l, useId as m, namespaceContextKey as n, useIdInjection as o, useNamespace as p, useNuxtApp as q, resolveRouteObject as r, useRoute as s, throwError as t, useGetDerivedNamespace as u, useRouter as v, useRuntimeConfig as w, useZIndex as x, zIndexContextKey as z };
